...
function Alamat() {
     return ( 
          <>
               <div className="bg-greentea w-full h-[48em] p-5 flex justify-around items-center flex-col text-slate-200 sm:space-y-2 sm:px-20 sm:py-[2em] lg:flex-row lg:h-[30em] 2xl:w-[70%] 2xl:mx-auto 2xl:my-10" >
                    <div >
                        <Iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15927.712500750034!2d98.45962823955078!3d3.603931600000002!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3030d618e8bd42bf%3A0x55266ca143e72b12!2sBadan%20Kesatuan%20Bangsa%20Politik%20dan%20Linmas%20Kota%20Binjai!5e0!3m2!1sen!2sid!4v1661546386624!5m2!1sen!2sid" style={{border:2}} allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" className='w-[300px] h-[350px] sm:w-[600px] sm:h-[350px] md:w-[600px] md:h-[400px] lg:w-[500px] lg:h-[400px]' ></Iframe>
                    </div>  
                    <section className='space-y-7 mx-2 z-[9] md:px-10 lg:px-10 lg:w-[80%]'>
                         <h2 className='font-semibold text-2xl lg:text-[2rem]'>Dimana BAKESBANGPOL Kota Binjai berada ?</h2>
                         <p className='lg:text-[1.1rem]'>Badan Kesatuan Bangsa dan Politik kota binjai terletak JL. JENDRAL GATOT SUBROTO No. 65 KOTA BINJAI, tidak jauh dari Tanah Lapang merdeka Kota Binjai. </p>
