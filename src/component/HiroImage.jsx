...
function HiroImage() {
     return (
       <div className="container_hiro w-screen justify-center items-center   ">
        <div className='w-screen flex justify-center -space-x-[100vw]  h-[65vh] lg:h-[70vh]'>
          <img src ={Hiro} alt="gambar header" className='mix-blend-screen w-full  transition duration-300 object-cover  '/>
          <div className="w-screen mix-blend-multiply bg-slate-700"></div>
          </div>
        <section className="w-full sm:w-full sm:mx-auto sm:px-20 px-10 h-[20em] flex flex-col justify-around items-start absolute top-0 mt-[11em] sm:mt-[12em] sm:items-center md:px-22 md:mt-[18em] lg:mt-[15em]  "> 
