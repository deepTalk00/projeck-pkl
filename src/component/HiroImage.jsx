     ...
     return (
       <div className="container_hiro w-screen h-screen ">
        <div className='w-screen flex justify-center -space-x-[100vw]'>
          <img src ={Hiro} alt="gambar header" className='mix-blend-screen bg-slate-400 h-[70vh] object-cover  '/>
        ...
        <secsion className="w-3/4  mx-11 h-[20em] flex flex-col justify-between items-start absolute top-0 translate-y-3/4"> 
          ...
          <button className="px-10 py-2 bg-greentea rounded-2xl shadow-xl drop-shadow-xl hover:ring-1 hover:ring-white focus:ring-2 focus:animate-none animate-bounce text-white uppercase font-serif">Pergi</button>
        </secsion>
       </div>
     );
   }
