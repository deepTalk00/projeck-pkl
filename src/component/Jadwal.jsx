...
function Layanan() {
     return ( 
          <>
               <div className="container_layanan w-full flex flex-col justify-between items-center lg:flex-row">
                    ...
                    <div className="container_layanan w-full h-[13em] bg-slate-800 p-4 flex flex-col justify-center text-white lg:p-0 lg:h-[15em]">
