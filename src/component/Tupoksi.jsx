     ...
     return ( 
          <>
                <section className=" w-full p-5 space-y-5 px-10 py-5 sm:px-20  lg:px-32 xl:px-52 xl:py-10 2xl:px-[22em]">
                    ...
                    Dalam melaksanakan tugas sebagaimana dimaksud pada ayat (2), Kepala Badan Kesatuan Bangsa dan Politik menyelenggarakan fungsi:  
                    merumuskan dan melaksanakan kebijakan di bidang kesatuan bangsa dan politik.
                 </p>
                    <p>
                    ...
                    melaksanakan tugas lain yang diberikan oleh atasan sesuai dengin bidang tugasnya.
                    </p>
               </section>
          </>
      );
