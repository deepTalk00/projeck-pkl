...
function IdeaApp() {
     return ( 
          <>
               <div className="container_ideaPokok bg-greentea text-white box-border w-full py-10 sm:px-12 lg:flex lg:px-20 lg:justify-center lg:items-center lg:px-48">
                    ...
                    <div className='images w-[90%] mx-auto gap-5 lg:w-[30%]  '>
